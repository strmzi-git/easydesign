      ...
      <Container>
        <div id="pricing" className="w-full gap-6">
          ...
          <div className="flex flex-col items-center py-4 mb-4">
            <h2 className="font-semibold text-[25px] md:text-[45px] w-fit text-center  text-primaryText">
              Affordable subscription plans
            </h2>
            <h4 className="font-light text-[12.5px] md:text-[15px] text-center max-w-[500px] text-[#333333]">
              Sign up in less than 30 seconds. Give our 7-day risk free trial a
              chance, cancel anytime, no questions, no hassle.
            </h4>
